...
> 1. Update the field for `thisMapType` - Use one of these map types: "Planet", "Continent", "Island". By default, the value will be set to "Continent" because that's the most likely kind of map FMG creates.
