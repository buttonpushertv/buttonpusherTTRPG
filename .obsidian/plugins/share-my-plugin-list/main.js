...
var ShareMyPluginSettingTab = class extends import_obsidian3.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian3.Setting(containerEl).setName("Open file after export").setDesc("Open the exported file after export.").addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.exportFileOpen).onChange(async (value) => {
    ...
    new import_obsidian3.Setting(containerEl).setName("Export file once Obsidian is started.").setDesc("Automatically update each time Obsidian is started").addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.exportFileWhenLoaded).onChange(async (value) => {
