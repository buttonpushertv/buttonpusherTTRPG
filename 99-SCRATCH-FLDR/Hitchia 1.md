...
>> ![[Hitchton Emblem Hitchia.png]]
>
>> ### Information
>> **Pronounced:** "`=this.pronounced`"
>> **Population:** `=this.totalPopulation`
>> <span style="font-size:small">**Urban:** `=this.urban` | **Rural:** `=this.rural`</span>
...
> scale: 5
> darkMode: false
> marker: capital,473.820,1952.830,[[]],Hitchia Capital
> ```
...
>
>> [!timeline|t-l t-2] **Manchan Campaign** *1471-1477*
>
