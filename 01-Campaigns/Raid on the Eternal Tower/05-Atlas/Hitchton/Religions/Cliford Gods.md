...
> [!metadata|map]- Cliford Gods Religions Map
> ```leaflet
> id: Religion-Cliford Gods
> image: [[Hitchton Religions World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [1143.100,1277.210]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: religion,1143.100,1277.210,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #bc80bd; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #bc80bd;">▮</div>
> The area shown in the color above is the reach of Cliford Gods
>
> [Link to Cliford Gods on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1277.21&y=174.9)
> 
...
> render: dom
> align: center
> id: map-religion-ClifordGods-8
> view:
>   zoom: 1
>   centerX: 0.48897779479326187
>   centerY: 0.132701062215478
> ```
> <div style="width: 500px; height: 20px; background-color: #bc80bd; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #bc80bd;">▮</div>
> The area shown in the color above is the reach of Cliford Gods
>
...
%%
ZOOMMAP-DATA id=map-religion-ClifordGods-8
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_ClifordGods_center",
      "x": 0.48897779479326187,
      "y": 0.132701062215478,
      "layer": "default",
      "link": "",
      "iconKey": "pinRed",
      "tooltip": "Cliford Gods Center"
    }
  ],
  "bases": [
    {
