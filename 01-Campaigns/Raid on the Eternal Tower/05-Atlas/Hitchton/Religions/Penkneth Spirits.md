...
> [!metadata|map]- Penkneth Spirits Religions Map
> ```leaflet
> id: Religion-Penkneth Spirits
...
> scale: 5
> darkMode: false
> marker: religion,960.290,1722.330,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #80b1d3; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #80b1d3;">▮</div>
> The area shown in the color above is the reach of Penkneth Spirits
>
> [Link to Penkneth Spirits on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1722.33&y=357.71)
> 
...
> [!metadata|map]+ Penkneth Spirits Map
> ```zoommap
> imageBases:
...
> render: dom
> align: center
> id: map-religion-PenknethSpirits-3
> view:
>   zoom: 1
>   centerX: 0.6593912710566615
>   centerY: 0.27140364188163885
> ```
> <div style="width: 500px; height: 20px; background-color: #80b1d3; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #80b1d3;">▮</div>
> The area shown in the color above is the reach of Penkneth Spirits
>
...
%%
ZOOMMAP-DATA id=map-religion-PenknethSpirits-3
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_PenknethSpirits_center",
      "x": 0.6593912710566615,
      "y": 0.27140364188163885,
      "layer": "default",
      "link": "",
      "iconKey": "pinRed",
      "tooltip": "Penkneth Spirits Center"
    }
  ],
  "bases": [
    {
