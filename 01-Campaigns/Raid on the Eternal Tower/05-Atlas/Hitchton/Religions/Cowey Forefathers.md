...
> [!metadata|map]- Cowey Forefathers Religions Map
> ```leaflet
> id: Religion-Cowey Forefathers
...
> [!metadata|map]+ Cowey Forefathers Map
> ```zoommap
> imageBases:
...
ZOOMMAP-DATA id=map-religion-CoweyForefathers-1
{
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_CoweyForefathers_center",
      "x": 0.783614088820827,
      "y": 0.31077389984825493,
      "layer": "default",
      "link": "",
      "iconKey": "pinRed",
      "tooltip": "Cowey Forefathers Center"
    }
  ],
  "bases": [
    {
