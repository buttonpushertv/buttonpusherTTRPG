...
> [!metadata|map]- Chisbute Spirits Religions Map
> ```leaflet
> id: Religion-Chisbute Spirits
...
> scale: 5
> darkMode: false
> marker: religion,626.660,2023.110,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #fdb462; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #fdb462;">▮</div>
> The area shown in the color above is the reach of Chisbute Spirits
>
> [Link to Chisbute Spirits on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=2023.11&y=691.34)
> 
...
> [!metadata|map]+ Chisbute Spirits Map
> ```zoommap
> imageBases:
...
> render: dom
> align: center
> id: map-religion-ChisbuteSpirits-4
> view:
>   zoom: 1
>   centerX: 0.7745444104134762
>   centerY: 0.5245371775417299
> ```
> <div style="width: 500px; height: 20px; background-color: #fdb462; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #fdb462;">▮</div>
> The area shown in the color above is the reach of Chisbute Spirits
>
...
%%
ZOOMMAP-DATA id=map-religion-ChisbuteSpirits-4
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_ChisbuteSpirits_center",
      "x": 0.7745444104134762,
      "y": 0.5245371775417299,
      "layer": "default",
      "link": "",
      "iconKey": "pinRed",
      "tooltip": "Chisbute Spirits Center"
    }
  ],
  "bases": [
    {
