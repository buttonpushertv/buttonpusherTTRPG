...
> [!metadata|map]- Religion of the Mad Religions Map
> ```leaflet
> id: Religion-Religion of the Mad
...
> scale: 5
> darkMode: false
> marker: religion,411.100,1511.350,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #ffe2d4; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #ffe2d4;">▮</div>
...
> [!metadata|map]+ Religion of the Mad Map
> ```zoommap
> imageBases:
...
ZOOMMAP-DATA id=map-religion-ReligionoftheMad-13
{
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_ReligionoftheMad_center",
      "x": 0.5786179173047473,
      "y": 0.6880880121396055,
      "layer": "default",
      "link": "",
      "iconKey": "pinRed",
      "tooltip": "Religion of the Mad Center"
    }
  ],
  "bases": [
    {
