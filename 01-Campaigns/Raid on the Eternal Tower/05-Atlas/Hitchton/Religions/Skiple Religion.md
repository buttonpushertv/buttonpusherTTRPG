...
> [!metadata|map]- Skiple Religion Religions Map
> ```leaflet
> id: Religion-Skiple Religion
...
> scale: 5
> darkMode: false
> marker: religion,228.200,1377.400,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #ebd8ff; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #ebd8ff;">▮</div>
...
> [!metadata|map]+ Skiple Religion Map
> ```zoommap
> imageBases:
...
ZOOMMAP-DATA map-religion-SkipleReligion-15
{
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_SkipleReligion_center",
      "x": 0.5273353751914243,
      "y": 0.8268588770864946,
      "layer": "default",
      "link": "",
      "iconKey": "pinRed",
      "tooltip": "Skiple Religion Center"
    }
  ],
  "bases": [
    {
