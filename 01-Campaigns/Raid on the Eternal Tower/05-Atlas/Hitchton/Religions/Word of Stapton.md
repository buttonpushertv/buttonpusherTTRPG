...
> [!metadata|map]- Word of Stapton Religions Map
> ```leaflet
> id: Religion-Word of Stapton
...
> ```
> <div style="width: 500px; height: 20px; background-color: #fae2d0; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #fae2d0;">▮</div>
...
> [!metadata|map]+ Word of Stapton Map
> ```zoommap
> imageBases:
...
ZOOMMAP-DATA id=map-religion-WordofStapton-11
{
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_WordofStapton_center",
      "x": 0.7463629402756509,
      "y": 0.6358877086494689,
      "layer": "default",
      "link": "",
      "iconKey": "pinRed",
      "tooltip": "Word of Stapton Center"
    }
  ],
  "bases": [
    {
