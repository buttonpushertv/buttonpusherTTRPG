...
> [!metadata|map]- Osbuton Spirits Religions Map
> ```leaflet
> id: Religion-Osbuton Spirits
> image: [[Hitchton Religions World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [844.000,629.700]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: religion,844.000,629.700,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #b3de69; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #b3de69;">▮</div>
> The area shown in the color above is the reach of Osbuton Spirits
>
> [Link to Osbuton Spirits on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=629.7&y=474)
> 
...
> [!metadata|map]+ Osbuton Spirits Map
> ```zoommap
> imageBases:
...
> render: dom
> align: center
> id: map-religion-OsbutonSpirits-2
> view:
>   zoom: 1
>   centerX: 0.24107963246554368
>   centerY: 0.3596358118361153
> ```
> <div style="width: 500px; height: 20px; background-color: #b3de69; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #b3de69;">▮</div>
> The area shown in the color above is the reach of Osbuton Spirits
>
...
%%
ZOOMMAP-DATA id=map-religion-OsbutonSpirits-2
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_OsbutonSpirits_center",
      "x": 0.24107963246554368,
      "y": 0.3596358118361153,
      "layer": "default",
      "link": "",
      "iconKey": "pinRed",
      "tooltip": "Osbuton Spirits Center"
    }
  ],
  "bases": [
    {
