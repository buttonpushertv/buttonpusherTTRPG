...
> [!metadata|map]- Old Bivenil Forefathers Religions Map
> ```leaflet
> id: Religion-Old Bivenil Forefathers
> image: [[Hitchton Religions World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [874.220,432.500]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: religion,874.220,432.500,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #fb8072; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #fb8072;">▮</div>
> The area shown in the color above is the reach of Old Bivenil Forefathers
>
> [Link to Old Bivenil Forefathers on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=432.5&y=443.78)
> 
...
> [!metadata|map]+ Old Bivenil Forefathers Map
> ```zoommap
> imageBases:
...
> render: dom
> align: center
> id: map-religion-OldBivenilForefathers-6
> view:
>   zoom: 1
>   centerX: 0.16558192955589587
>   centerY: 0.3367071320182094
> ```
> <div style="width: 500px; height: 20px; background-color: #fb8072; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #fb8072;">▮</div>
> The area shown in the color above is the reach of Old Bivenil Forefathers
>
...
%%
ZOOMMAP-DATA id=map-religion-OldBivenilForefathers-6
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_OldBivenilForefathers_center",
      "x": 0.16558192955589587,
      "y": 0.3367071320182094,
      "layer": "default",
      "link": "",
      "iconKey": "pinRed",
      "tooltip": "Old Bivenil Forefathers Center"
    }
  ],
  "bases": [
    {
