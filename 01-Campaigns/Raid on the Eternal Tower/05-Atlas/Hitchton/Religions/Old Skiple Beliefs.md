...
culture: Skiple
deity: Marshelmond, The Unhappy Chimera
expansion: culture
expansionism: 0
extinct: false
followers: 213,212
...
- Religion of the Mad
pronounced: ""
religionName: "Old Skiple Beliefs"
...
> [!metadata|map]- Old Skiple Beliefs Religions Map
> ```leaflet
> id: Religion-Old Skiple Beliefs
> image: [[Hitchton Religions World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [556.220,1009.560]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: religion,556.220,1009.560,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #fccde5; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #fccde5;">▮</div>
> The area shown in the color above is the reach of Old Skiple Beliefs
>
> [Link to Old Skiple Beliefs on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1009.56&y=761.78)
> 
...
> [!metadata|map]+ Old Skiple Beliefs Map
> ```zoommap
> imageBases:
...
> render: dom
> align: center
> id: map-religion-OldSkipleBeliefs-7
> view:
>   zoom: 1
>   centerX: 0.38650842266462476
>   centerY: 0.5779817905918058
> ```
> <div style="width: 500px; height: 20px; background-color: #fccde5; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #fccde5;">▮</div>
> The area shown in the color above is the reach of Old Skiple Beliefs
>
...
%%
ZOOMMAP-DATA id=map-religion-OldSkipleBeliefs-7
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_OldSkipleBeliefs_center",
      "x": 0.38650842266462476,
      "y": 0.5779817905918058,
      "layer": "default",
      "link": "",
      "iconKey": "pinRed",
      "tooltip": "Old Skiple Beliefs Center"
    }
  ],
  "bases": [
    {
