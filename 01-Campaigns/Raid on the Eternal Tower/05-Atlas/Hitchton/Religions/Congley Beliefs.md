...
> [!metadata|map]- Congley Beliefs Religions Map
> ```leaflet
> id: Religion-Congley Beliefs
> image: [[Hitchton Religions World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [760.220,1375.320]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: religion,760.220,1375.320,,Religion's Center
> ```
...
> [!metadata|map]+ Congley Beliefs Map
> ```zoommap
> imageBases:
...
> render: dom
> align: center
> id: map-religion-CongleyBeliefs-9
> view:
>   zoom: 1
>   centerX: 0.5265390505359877
>   centerY: 0.42320182094081943
> ```
> <div style="width: 500px; height: 20px; background-color: #c6b9c1; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #c6b9c1;">▮</div>
> The area shown in the color above is the reach of Congley Beliefs
>
