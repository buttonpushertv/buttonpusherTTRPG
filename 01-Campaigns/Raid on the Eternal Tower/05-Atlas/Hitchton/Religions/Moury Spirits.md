...
> [!metadata|map]- Moury Spirits Religions Map
> ```leaflet
> id: Religion-Moury Spirits
> image: [[Hitchton Religions World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [1146.500,1205.100]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: religion,1146.500,1205.100,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #dababf; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #dababf;">▮</div>
> The area shown in the color above is the reach of Moury Spirits
>
> [Link to Moury Spirits on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1205.1&y=171.5)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Moury Spirits Map
> ```zoommap
> imageBases:
...
> render: dom
> align: center
> id: map-religion-MourySpirits-5
> view:
>   zoom: .5
>   centerX: 0.46137059724349155
>   centerY: 0.13012139605462822
> ```
> <div style="width: 500px; height: 20px; background-color: #dababf; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #dababf;">▮</div>
> The area shown in the color above is the reach of Moury Spirits
>
> [Link to Moury Spirits on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1205.1&y=171.5)
%%
ZOOMMAP-DATA id=map-religion-MourySpirits-5
{
  "size": {
    "w": 2612,
    "h": 1318
...
%%
ZOOMMAP-DATA map-religion-MourySpirits-5
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_MourySpirits_center",
      "x": 0.46137059724349155,
      "y": 0.13012139605462822,
      "layer": "default",
      "link": "",
      "iconKey": "pinRed",
      "tooltip": "Moury Spirits Center"
    }
  ],
  "bases": [
    {
