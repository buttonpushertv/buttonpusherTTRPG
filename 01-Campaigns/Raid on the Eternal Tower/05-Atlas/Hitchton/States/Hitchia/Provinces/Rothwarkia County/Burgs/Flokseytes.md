...
- Flokseytes
- Flokseytes-587
burgMapLink: https://watabou.github.io/village-generator/?pop=602&name=Flokseytes&seed=5827453500587&width=1000&height=455&tags=isolated%2Cno+square%2Cdense
burgName: Flokseytes
burgNameID: Flokseytes-587
...
culture: Daling
elevation: 738 ft
emblem: Hitchton Emblem Flokseytes.png
group: village
feature: 2
id: 587
mapName: Hitchton
...
marker: burg,495.890,1845.690,[[Flokseytes]]
%%
...
>> ![[Hitchton Emblem Flokseytes.png]]
>
>> ### Information
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/village-generator/?pop=602&name=Flokseytes&seed=5827453500587&width=1000&height=455&tags=isolated%2Cno+square%2Cdense
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Flokseytes on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=1845.69&y=822.11) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]+ Flokseytes Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Flokseytes-587.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
> render: dom
> align: center
> id: map-Flokseytes-587
> view:
>   zoom: .5
>   centerX: .5
>   centerY: .5
> ```
> [Link to Flokseytes on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Flokseytes-587
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Flokseytes-587.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
