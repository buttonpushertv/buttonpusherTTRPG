...
- Gasingswest
- Gasingswest-337
burgMapLink: https://watabou.github.io/city-generator/?name=Gasingswest&population=12016&size=33&seed=5827453500337&river=0&coast=0&farms=0&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=1&shantytown=0&greens=0&style=natural
burgName: Gasingswest
burgNameID: Gasingswest-337
...
culture: Penkneth
elevation: 7878 ft
emblem: Hitchton Emblem Gasingswest.png
group: town
feature: 2
id: 337
mapName: Hitchton
marketId: 25
marketName: Mouton-market
plaza: 0
population: 12,016
port: 
product: 35.23
pronounced: ""
provinceId: 195
provinceName: Gasingswest Seneschalty
...
stateId: 19
stateName: Birbotia
stateNotePath: "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Birbotia/Birbotia"
tags:
- Burg
- Hitchton
- roet
...
marker: burg,692.690,1748.280,[[Gasingswest]]
%%
...
>> ![[Hitchton Emblem Gasingswest.png]]
>
>> ### Information
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/city-generator/?name=Gasingswest&population=12016&size=33&seed=5827453500337&river=0&coast=0&farms=0&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=1&shantytown=0&greens=0&style=natural
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Gasingswest on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=1748.28&y=625.31) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]- Gasingswest Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Gasingswest-337.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
> render: dom
> align: center
> id: map-Gasingswest-337
> view:
>   zoom: .5
>   centerX: .5
>   centerY: .5
> ```
> [Link to Gasingswest on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

-TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Gasingswest-337
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Gasingswest-337.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
