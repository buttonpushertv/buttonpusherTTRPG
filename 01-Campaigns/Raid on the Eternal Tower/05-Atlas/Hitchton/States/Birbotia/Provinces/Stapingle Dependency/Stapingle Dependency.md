...
emblem: Hitchton Emblem Stapingle Dependency.png
formName: Dependency
fullName: Stapingle Dependency
pulledName: Stapingle Dependency
id: 224
name: Stapingle
nameID: Stapingle-224
mapName: Hitchton
pronounced: ""
provincialCapital: Stapingle
capitalFile: 01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Birbotia/Provinces/Stapingle Dependency/Burgs/Stapingle
rulers:
...
>> ![[Hitchton Emblem Stapingle Dependency.png]]
>
>> ### Information
...
> [!metadata|map]+ Stapingle Dependency - Province World Map
> ```leaflet
> id: Province-Stapingle-224
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [752.100,1916.170]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,752.100,1916.170,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Birbotia/Provinces/Stapingle Dependency/Burgs/Stapingle|Stapingle]],Stapingle Provincial Capital
> ```
>  [Link to Stapingle Dependency on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1916.17&y=565.9)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Stapingle Dependency Province Map
> ```zoommap
> imageBases:
...
> render: dom
> align: center
> id: map-Stapingle-224
> view:
>   zoom: 1.5
>   centerX: 0.7480857580398163
>   centerY: 0.424886191198786
> ```
> [Link to Stapingle on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1916.17&y=565.9)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Stapingle-224
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Stapingle_216",
      "x": 0.7336026033690659,
      "y": 0.4293626707132018,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Birbotia/Provinces/Stapingle Dependency/Burgs/Stapingle",
      "iconKey": "pinRed",
      "tooltip": "Stapingle Dependency Capital - Stapingle"
    }
  ],
  "bases": [
    {
