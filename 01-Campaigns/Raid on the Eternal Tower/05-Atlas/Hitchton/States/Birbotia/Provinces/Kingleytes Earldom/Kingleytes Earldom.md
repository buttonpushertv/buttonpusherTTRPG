...
formName: Earldom
fullName: Kingleytes Earldom
pulledName: Kingleytes Earldom
id: 200
name: Kingleytes
...
>> ![[Hitchton Emblem Kingleytes Earldom.png]]
>
>> ### Information
...
> [!metadata|map]+ Kingleytes Earldom - Province World Map
> ```leaflet
> id: Province-Kingleytes-200
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [793.230,1513.700]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,793.230,1513.700,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Birbotia/Provinces/Kingleytes Earldom/Burgs/Kingleytes|Kingleytes]],Kingleytes Provincial Capital
> ```
>  [Link to Kingleytes Earldom on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1513.7&y=524.77)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Kingleytes Earldom Province Map
> ```zoommap
> imageBases:
...
> render: dom
> align: center
> id: map-Kingleytes-200
> view:
>   zoom: 1.5
>   centerX: 0.5800153139356815
>   centerY: 0.3975720789074355
> ```
> [Link to Kingleytes on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1513.7&y=524.77)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Kingleytes-200
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Kingleytes_639",
      "x": 0.5795176110260337,
      "y": 0.3981562974203338,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Birbotia/Provinces/Kingleytes Earldom/Burgs/Kingleytes",
      "iconKey": "pinRed",
      "tooltip": "Kingleytes Earldom Capital - Kingleytes"
    }
  ],
  "bases": [
    {
