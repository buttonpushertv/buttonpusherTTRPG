...
- Kingleytes
- Kingleytes-639
burgMapLink: https://watabou.github.io/city-generator/?name=Kingleytes&population=5599&size=25&seed=5827453500639&river=0&coast=0&farms=0&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
burgName: Kingleytes
burgNameID: Kingleytes-639
...
culture: Penkneth
elevation: 3573 ft
emblem: Hitchton Emblem Kingleytes.png
group: town
feature: 2
id: 639
mapName: Hitchton
...
pronounced: ""
provinceId: 200
provinceName: Kingleytes Earldom
...
marker: burg,793.230,1513.700,[[Kingleytes]]
%%
...
>> ![[Hitchton Emblem Kingleytes.png]]
>
>> ### Information
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/city-generator/?name=Kingleytes&population=5599&size=25&seed=5827453500639&river=0&coast=0&farms=0&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Kingleytes on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=1513.7&y=524.77) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]+ Kingleytes Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Kingleytes-639.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
> render: dom
> align: center
> id: map-Kingleytes-639
> view:
>   zoom: .5
>   centerX: .5
>   centerY: .5
> ```
> [Link to Kingleytes on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Kingleytes-639
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Kingleytes-639.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
