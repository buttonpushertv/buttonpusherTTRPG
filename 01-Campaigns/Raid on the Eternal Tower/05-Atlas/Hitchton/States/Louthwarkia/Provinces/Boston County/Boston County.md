...
formName: County
fullName: Boston County
pulledName: Boston County
id: 123
name: Boston
nameID: Boston-123
mapName: Hitchton
...
>> ![[Hitchton Emblem Boston County.png]]
>
>> ### Information
...
> [!metadata|map]+ Boston County - Province World Map
> ```leaflet
> id: Province-Boston-123
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [547.660,1850.270]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,547.770,1850.380,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Louthwarkia/Provinces/Boston County/Burgs/Boston|Boston]],Boston Provincial Capital
> ```
>  [Link to Boston County on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1850.27&y=770.34)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Boston County Province Map
> ```zoommap
> imageBases:
...
> view:
>   zoom: 1.5
>   centerX: 0.7025267993874426
>   centerY: 0.5728376327769348
> ```
> [Link to Boston on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1850.27&y=770.34)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Boston-123
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Boston_627",
      "x": 0.7084150076569679,
      "y": 0.5843930197268589,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Louthwarkia/Provinces/Boston County/Burgs/Boston",
      "iconKey": "pinRed",
      "tooltip": "Boston County Capital - Boston"
    }
  ],
  "bases": [
    {
