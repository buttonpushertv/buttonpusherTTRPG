...
- Bretfieldge
- Bretfieldge-537
burgMapLink: https://watabou.github.io/city-generator/?name=Bretfieldge&population=5804&size=25&seed=5827453500537&river=0&coast=0&farms=1&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
burgName: Bretfieldge
burgNameID: Bretfieldge-537
...
culture: Bivenil
elevation: 210 ft
emblem: Hitchton Emblem Bretfieldge.png
group: town
feature: 2
id: 537
mapName: Hitchton
...
marker: burg,870.800,498.500,[[Bretfieldge]]
%%
...
>> ![[Hitchton Emblem Bretfieldge.png]]
>
>> ### Information
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/city-generator/?name=Bretfieldge&population=5804&size=25&seed=5827453500537&river=0&coast=0&farms=1&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Bretfieldge on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=498.5&y=447.2) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]- Bretfieldge Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Bretfieldge-537.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
> render: dom
> align: center
> id: map-Bretfieldge-537
> view:
>   zoom: .5
>   centerX: .5
>   centerY: .5
> ```
> [Link to Bretfieldge on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

-TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Bretfieldge-537
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Bretfieldge-537.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
