...
fullName: Boltonces Seneschalty
pulledName: Boltonces Seneschalty
id: 178
name: Boltonces
...
>> ![[Hitchton Emblem Boltonces Seneschalty.png]]
>
>> ### Information
...
> [!metadata|map]+ Boltonces Seneschalty - Province World Map
> ```leaflet
> id: Province-Boltonces-178
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [857.310,607.200]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,861.770,611.290,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Madeteria/Provinces/Boltonces Seneschalty/Burgs/Boltonces|Boltonces]],Boltonces Provincial Capital
> ```
>  [Link to Boltonces Seneschalty on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=607.2&y=460.69)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Boltonces Seneschalty Province Map
> ```zoommap
> imageBases:
...
> render: dom
> align: center
> id: map-Boltonces-178
> view:
>   zoom: 1.5
>   centerX: 0.2343032159264931
>   centerY: 0.3960546282245827
> ```
> [Link to Boltonces on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=607.2&y=460.69)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Boltonces-178
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Boltonces_318",
      "x": 0.234031393568147,
      "y": 0.34615326251896816,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Madeteria/Provinces/Boltonces Seneschalty/Burgs/Boltonces",
      "iconKey": "pinRed",
      "tooltip": "Boltonces Seneschalty Capital - Boltonces"
    }
  ],
  "bases": [
    {
