...
- Skipseale
- Skipseale-427
burgMapLink: https://watabou.github.io/city-generator/?name=Skipseale&population=2160&size=17&seed=5827453500427&river=0&coast=0&farms=1&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
burgName: Skipseale
burgNameID: Skipseale-427
...
culture: Bivenil
elevation: 554 ft
emblem: Hitchton Emblem Skipseale.png
group: town
feature: 2
id: 427
mapName: Hitchton
...
pronounced: ""
provinceId: 178
provinceName: Boltonces Seneschalty
...
marker: burg,831.770,587.660,[[Skipseale]]
%%
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/city-generator/?name=Skipseale&population=2160&size=17&seed=5827453500427&river=0&coast=0&farms=1&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Skipseale on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=587.66&y=486.23) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]- Skipseale Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Skipseale-427.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
> render: dom
> align: center
> id: map-Skipseale-427
> view:
>   zoom: .5
>   centerX: .5
>   centerY: .5
> ```
> [Link to Skipseale on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

-TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Skipseale-427
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Skipseale-427.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
