...
formName: Dependency
fullName: Marsland Dependency
pulledName: Marsland Dependency
id: 222
name: Marsland
nameID: Marsland-222
mapName: Hitchton
...
>> ![[Hitchton Emblem Marsland Dependency.png]]
>
>> ### Information
...
> [!metadata|map]+ Marsland Dependency - Province World Map
> ```leaflet
> id: Province-Marsland-222
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [732.640,578.920]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,,[[|Unspecified]],Marsland Provincial Capital
> ```
>  [Link to Marsland Dependency on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=578.92&y=585.36)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Marsland Dependency Province Map
> ```zoommap
> imageBases:
...
> view:
>   zoom: 1.5
>   centerX: 0.225114854517611
>   centerY: 0.44764795144157815
> ```
> [Link to Marsland on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=578.92&y=585.36)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Marsland-222
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      ...
      "link": "",
      "iconKey": "pinRed",
      "tooltip": "Marsland Dependency Capital - Unspecified"
    }
  ],
  "bases": [
    {
