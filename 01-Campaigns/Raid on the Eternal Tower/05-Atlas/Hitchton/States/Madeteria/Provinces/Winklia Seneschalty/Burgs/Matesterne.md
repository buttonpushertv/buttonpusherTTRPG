...
- Matesterne
- Matesterne-151
burgMapLink: https://watabou.github.io/village-generator/?pop=1891&name=Matesterne&seed=5827453500151&width=1600&height=727&tags=estuary%2Cisolated%2Cno+square%2Cdense
burgName: Matesterne
burgNameID: Matesterne-151
...
culture: Bivenil
elevation: 13 ft
emblem: Hitchton Emblem Matesterne.png
group: village
feature: 2
id: 151
mapName: Hitchton
...
marker: burg,906.550,349.120,[[Matesterne]]
%%
...
>> ![[Hitchton Emblem Matesterne.png]]
>
>> ### Information
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/village-generator/?pop=1891&name=Matesterne&seed=5827453500151&width=1600&height=727&tags=estuary%2Cisolated%2Cno+square%2Cdense
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Matesterne on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=360.8&y=410.5) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]- Matesterne Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Matesterne-151.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
> render: dom
> align: center
> id: map-Matesterne-151
> view:
>   zoom: .5
>   centerX: .5
>   centerY: .5
> ```
> [Link to Matesterne on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

-TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Matesterne-151
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Matesterne-151.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
