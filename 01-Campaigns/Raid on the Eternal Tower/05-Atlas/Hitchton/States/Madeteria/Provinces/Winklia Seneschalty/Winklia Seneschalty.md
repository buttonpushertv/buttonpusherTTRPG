...
fullName: Winklia Seneschalty
pulledName: Winklia Seneschalty
id: 181
name: Winklia
nameID: Winklia-181
mapName: Hitchton
...
>> ![[Hitchton Emblem Winklia Seneschalty.png]]
>
>> ### Information
...
> [!metadata|map]+ Winklia Seneschalty - Province World Map
> ```leaflet
> id: Province-Winklia-181
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [861.210,366.500]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,860.610,366.550,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Madeteria/Provinces/Winklia Seneschalty/Burgs/Retfordford|Retfordford]],Winklia Provincial Capital
> ```
>  [Link to Winklia Seneschalty on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=366.5&y=456.79)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Winklia Seneschalty Province Map
> ```zoommap
> imageBases:
...
> view:
>   zoom: 1.5
>   centerX: 0.14203675344563552
>   centerY: 0.3224582701062215
> ```
> [Link to Winklia on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=366.5&y=456.79)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Winklia-181
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Retfordford_213",
      "x": 0.14033307810107198,
      "y": 0.34703338391502275,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Madeteria/Provinces/Winklia Seneschalty/Burgs/Retfordford",
      "iconKey": "pinRed",
      "tooltip": "Winklia Seneschalty Capital - Retfordford"
    }
  ],
  "bases": [
    {
