...
formName: Landgrave
fullName: Whitfordge Landgrave
pulledName: Whitfordge Landgrave
id: 179
name: Whitfordge
...
>> ![[Hitchton Emblem Whitfordge Landgrave.png]]
>
>> ### Information
...
> [!metadata|map]+ Whitfordge Landgrave - Province World Map
> ```leaflet
> id: Province-Whitfordge-179
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [918.360,566.250]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,918.360,566.250,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Madeteria/Provinces/Whitfordge Landgrave/Burgs/Whitfordge|Whitfordge]],Whitfordge Provincial Capital
> ```
>  [Link to Whitfordge Landgrave on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=566.25&y=399.64)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Whitfordge Landgrave Province Map
> ```zoommap
> imageBases:
...
> render: dom
> align: center
> id: map-Whitfordge-179
> view:
>   zoom: 1.5
>   centerX: 0.21937212863705974
>   centerY: 0.28148710166919577
> ```
> [Link to Whitfordge on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=566.25&y=399.64)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Whitfordge-179
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Whitfordge_197",
      "x": 0.21678790199081163,
      "y": 0.30321699544764796,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Madeteria/Provinces/Whitfordge Landgrave/Burgs/Whitfordge",
      "iconKey": "pinRed",
      "tooltip": "Whitfordge Landgrave Capital - Whitfordge"
    }
  ],
  "bases": [
    {
