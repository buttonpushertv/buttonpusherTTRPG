...
- Sidgego
- Sidgego-576
burgMapLink: https://watabou.github.io/city-generator/?name=Sidgego&population=2436&size=18&seed=5827453500576&river=1&coast=0&farms=0&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
burgName: Sidgego
burgNameID: Sidgego-576
...
culture: Cliford
elevation: 30 ft
emblem: Hitchton Emblem Sidgego.png
group: town
feature: 2
id: 576
mapName: Hitchton
...
pronounced: ""
provinceId: 154
provinceName: Presfieldia County
...
marker: burg,1144.530,1788.250,[[Sidgego]]
%%
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/city-generator/?name=Sidgego&population=2436&size=18&seed=5827453500576&river=1&coast=0&farms=0&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Sidgego on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=1787.74&y=173.38) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]- Sidgego Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Sidgego-576.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
>   centerY: .5
> ```
> [Link to Sidgego on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

-TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Sidgego-576
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Sidgego-576.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
