...
- Albrid
- Albrid-124
burgMapLink: https://watabou.github.io/city-generator/?name=Albrid&population=10134&size=31&seed=5827453500124&river=0&coast=0&farms=1&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=1&shantytown=0&greens=0&style=natural
burgName: Albrid
burgNameID: Albrid-124
...
marker: burg,1022.320,1692.100,[[Albrid]]
%%
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/city-generator/?name=Albrid&population=10134&size=31&seed=5827453500124&river=0&coast=0&farms=1&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=1&shantytown=0&greens=0&style=natural
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Albrid on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=1692.1&y=295.68) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Albrid-124.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
%%
ZOOMMAP-DATA id=map-Albrid-124
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Albrid-124.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
