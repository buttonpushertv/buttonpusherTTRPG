...
emblem: Hitchton Emblem Framping County.png
formName: County
fullName: Framping County
pulledName: Framping County
id: 83
name: Framping
nameID: Framping-83
mapName: Hitchton
pronounced: ""
provincialCapital: Orton
...
>> ![[Hitchton Emblem Framping County.png]]
>
>> ### Information
...
> [!metadata|map]+ Framping County - Province World Map
> ```leaflet
> id: Province-Framping-83
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [399.110,1771.980]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,399.080,1771.380,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Manch/Provinces/Framping County/Burgs/Orton|Orton]],Framping Provincial Capital
> ```
>  [Link to Framping County on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1771.98&y=918.89)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Framping County Province Map
> ```zoommap
> imageBases:
...
> view:
>   zoom: 1.5
>   centerX: 0.6696018376722818
>   centerY: 0.7056145675265554
> ```
> [Link to Framping on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1771.98&y=918.89)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Framping-83
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      ...
      "iconKey": "pinRed",
      "tooltip": "Framping County Capital - Orton"
    }
  ],
  "bases": [
    {
