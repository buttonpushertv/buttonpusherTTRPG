...
formName: Shire
fullName: Bridge Shire
pulledName: Bridge Shire
id: 86
name: Bridge
nameID: Bridge-86
mapName: Hitchton
...
>> ![[Hitchton Emblem Bridge Shire.png]]
>
>> ### Information
...
> [!metadata|map]+ Bridge Shire - Province World Map
> ```leaflet
> id: Province-Bridge-86
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [401.790,1850.720]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,401.600,1850.460,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Manch/Provinces/Bridge Shire/Burgs/Bridge|Bridge]],Bridge Provincial Capital
> ```
>  [Link to Bridge Shire on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1850.72&y=916.21)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Bridge Shire Province Map
> ```zoommap
> imageBases:
...
> ```
> [Link to Bridge on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1850.72&y=916.21)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Bridge-86
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Bridge_148",
      "x": 0.7084456355283308,
      "y": 0.6952959028831562,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Manch/Provinces/Bridge Shire/Burgs/Bridge",
      "iconKey": "pinRed",
      "tooltip": "Bridge Shire Capital - Bridge"
    }
  ],
  "bases": [
    {
