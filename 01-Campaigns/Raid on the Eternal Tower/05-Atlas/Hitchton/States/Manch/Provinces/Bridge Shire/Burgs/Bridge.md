...
- Bridge
- Bridge-148
burgMapLink: https://watabou.github.io/city-generator/?name=Bridge&population=14338&size=35&seed=5827453500148&river=1&coast=0&farms=1&citadel=1&urban_castle=1&hub=1&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
burgName: Bridge
burgNameID: Bridge-148
...
culture: Daling
elevation: 52 ft
emblem: Hitchton Emblem Bridge.png
group: city
feature: 2
id: 148
mapName: Hitchton
...
marker: burg,401.600,1850.460,[[Bridge]]
%%
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/city-generator/?name=Bridge&population=14338&size=35&seed=5827453500148&river=1&coast=0&farms=1&citadel=1&urban_castle=1&hub=1&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Bridge on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=1850.72&y=916.21) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]- Bridge Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Bridge-148.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
>   centerY: .5
> ```
> [Link to Bridge on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

-TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Bridge-148
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Bridge-148.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
