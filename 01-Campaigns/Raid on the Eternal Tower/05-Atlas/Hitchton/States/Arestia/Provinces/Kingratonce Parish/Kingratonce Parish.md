...
emblem: Hitchton Emblem Kingratonce Parish.png
formName: Parish
fullName: Kingratonce Parish
pulledName: Kingratonce Parish
id: 21
name: Kingratonce
nameID: Kingratonce-21
mapName: Hitchton
pronounced: ""
provincialCapital: Kingratonce
capitalFile: 01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Arestia/Provinces/Kingratonce Parish/Burgs/Kingratonce
rulers:
...
>> ![[Hitchton Emblem Kingratonce Parish.png]]
>
>> ### Information
...
> [!metadata|map]+ Kingratonce Parish - Province World Map
> ```leaflet
> id: Province-Kingratonce-21
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [831.360,1903.210]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,831.360,1903.210,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Arestia/Provinces/Kingratonce Parish/Burgs/Kingratonce|Kingratonce]],Kingratonce Provincial Capital
> ```
>  [Link to Kingratonce Parish on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1903.21&y=486.64)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Kingratonce Parish Province Map
> ```zoommap
> imageBases:
...
> render: dom
> align: center
> id: map-Kingratonce-21
> view:
>   zoom: 1.5
>   centerX: 0.7300918836140888
>   centerY: 0.38012139605462825
> ```
> [Link to Kingratonce on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1903.21&y=486.64)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Kingratonce-21
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Kingratonce_133",
      "x": 0.7286408882082696,
      "y": 0.36922610015174506,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Arestia/Provinces/Kingratonce Parish/Burgs/Kingratonce",
      "iconKey": "pinRed",
      "tooltip": "Kingratonce Parish Capital - Kingratonce"
    }
  ],
  "bases": [
    {
