...
- Penkseymock
- Penkseymock-253
burgMapLink: https://watabou.github.io/city-generator/?name=Penkseymock&population=4054&size=22&seed=5827453500253&river=1&coast=0&farms=1&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
burgName: Penkseymock
burgNameID: Penkseymock-253
...
culture: Cowey
elevation: 266 ft
emblem: Hitchton Emblem Penkseymock.png
group: town
feature: 2
id: 253
mapName: Hitchton
...
marker: burg,857.170,2008.070,[[Penkseymock]]
%%
...
>> ![[Hitchton Emblem Penkseymock.png]]
>
>> ### Information
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/city-generator/?name=Penkseymock&population=4054&size=22&seed=5827453500253&river=1&coast=0&farms=1&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Penkseymock on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=2007.59&y=460.55) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]- Penkseymock Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Penkseymock-253.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
> render: dom
> align: center
> id: map-Penkseymock-253
> view:
>   zoom: .5
>   centerX: .5
>   centerY: .5
> ```
> [Link to Penkseymock on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

-TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Penkseymock-253
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Penkseymock-253.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
