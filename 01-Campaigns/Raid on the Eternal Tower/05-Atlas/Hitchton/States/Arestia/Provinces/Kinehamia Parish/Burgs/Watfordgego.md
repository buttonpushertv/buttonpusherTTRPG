...
- Watfordgego
- Watfordgego-195
burgMapLink: https://watabou.github.io/city-generator/?name=Watfordgego&population=10150&size=31&seed=5827453500195&river=0&coast=0&farms=0&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
burgName: Watfordgego
burgNameID: Watfordgego-195
...
culture: Penkneth
elevation: 4019 ft
emblem: Hitchton Emblem Watfordgego.png
group: town
feature: 2
id: 195
mapName: Hitchton
...
marker: burg,957.620,1819.850,[[Watfordgego]]
%%
...
>> ![[Hitchton Emblem Watfordgego.png]]
>
>> ### Information
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/city-generator/?name=Watfordgego&population=10150&size=31&seed=5827453500195&river=0&coast=0&farms=0&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Watfordgego on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=1819.85&y=360.38) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]+ Watfordgego Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Watfordgego-195.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
> render: dom
> align: center
> id: map-Watfordgego-195
> view:
>   zoom: .5
>   centerX: .5
>   centerY: .5
> ```
> [Link to Watfordgego on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Watfordgego-195
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Watfordgego-195.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
