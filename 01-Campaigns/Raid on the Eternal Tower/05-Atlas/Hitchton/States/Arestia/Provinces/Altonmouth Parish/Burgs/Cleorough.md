...
- Cleorough
- Cleorough-343
burgMapLink: https://watabou.github.io/city-generator/?name=Cleorough&population=4671&size=23&seed=5827453500343&river=0&coast=0&farms=0&citadel=1&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
burgName: Cleorough
burgNameID: Cleorough-343
...
culture: Cowey
elevation: 30 ft
emblem: Hitchton Emblem Cleorough.png
group: town
feature: 2
id: 343
mapName: Hitchton
...
marker: burg,997.860,2011.800,[[Cleorough]]
%%
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/city-generator/?name=Cleorough&population=4671&size=23&seed=5827453500343&river=0&coast=0&farms=0&citadel=1&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Cleorough on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=2011.8&y=320.14) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]+ Cleorough Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Cleorough-343.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
> render: dom
> align: center
> id: map-Cleorough-343
> view:
>   zoom: .5
>   centerX: .5
>   centerY: .5
> ```
> [Link to Cleorough on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Cleorough-343
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Cleorough-343.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
