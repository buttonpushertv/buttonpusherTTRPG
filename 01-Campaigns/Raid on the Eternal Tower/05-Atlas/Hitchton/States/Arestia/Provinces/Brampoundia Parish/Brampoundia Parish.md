...
formName: Parish
fullName: Brampoundia Parish
pulledName: Brampoundia Parish
id: 15
name: Brampoundia
...
>> ![[Hitchton Emblem Brampoundia Parish.png]]
>
>> ### Information
...
> [!metadata|map]+ Brampoundia Parish - Province World Map
> ```leaflet
> id: Province-Brampoundia-15
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [843.940,1943.200]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,844.460,1943.510,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Arestia/Provinces/Brampoundia Parish/Burgs/Castry|Castry]],Brampoundia Provincial Capital
> ```
>  [Link to Brampoundia Parish on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1943.2&y=474.06)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Brampoundia Parish Province Map
> ```zoommap
> imageBases:
...
> render: dom
> align: center
> id: map-Brampoundia-15
> view:
>   zoom: 1.5
>   centerX: 0.7377488514548239
>   centerY: 0.3512898330804249
> ```
> [Link to Brampoundia on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1943.2&y=474.06)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Brampoundia-15
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Castry_35",
      "x": 0.7440696784073507,
      "y": 0.3592867981790592,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Arestia/Provinces/Brampoundia Parish/Burgs/Castry",
      "iconKey": "pinRed",
      "tooltip": "Brampoundia Parish Capital - Castry"
    }
  ],
  "bases": [
    {
