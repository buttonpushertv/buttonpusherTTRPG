...
formName: Region
fullName: Maveternia Region
pulledName: Maveternia Region
id: 210
name: Maveternia
...
>> ![[Hitchton Emblem Maveternia Region.png]]
>
>> ### Information
...
> [!metadata|map]+ Maveternia Region - Province World Map
> ```leaflet
> id: Province-Maveternia-210
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [898.590,1244.790]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,898.410,1244.720,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Oakhambia/Provinces/Maveternia Region/Burgs/Pilter|Pilter]],Maveternia Provincial Capital
> ```
>  [Link to Maveternia Region on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1244.79&y=419.41)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Maveternia Region Province Map
> ```zoommap
> imageBases:
...
> render: dom
> align: center
> id: map-Maveternia-210
> view:
>   zoom: 1.5
>   centerX: 0.48813169984686067
>   centerY: 0.48710166919575115
> ```
> [Link to Maveternia on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1244.79&y=419.41)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Maveternia-210
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Pilter_276",
      "x": 0.4765390505359878,
      "y": 0.3183535660091047,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Oakhambia/Provinces/Maveternia Region/Burgs/Pilter",
      "iconKey": "pinRed",
      "tooltip": "Maveternia Region Capital - Pilter"
    }
  ],
  "bases": [
    {
