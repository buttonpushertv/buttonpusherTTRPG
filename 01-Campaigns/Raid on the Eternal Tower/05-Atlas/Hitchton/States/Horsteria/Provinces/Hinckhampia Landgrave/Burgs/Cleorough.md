...
- Cleorough
- Cleorough-476
burgMapLink: https://watabou.github.io/village-generator/?pop=785&name=Cleorough&seed=5827453500476&width=1000&height=455&tags=isolated%2Cno+square%2Cdense
burgName: Cleorough
burgNameID: Cleorough-476
...
marker: burg,843.100,774.600,[[Cleorough]]
%%
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/village-generator/?pop=785&name=Cleorough&seed=5827453500476&width=1000&height=455&tags=isolated%2Cno+square%2Cdense
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Cleorough on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=774.6&y=474.9) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Cleorough-476.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
%%
ZOOMMAP-DATA id=map-Cleorough-476
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Cleorough-476.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
