...
- Whiteston
- Whiteston-452
burgMapLink: https://watabou.github.io/city-generator/?name=Whiteston&population=8450&size=29&seed=5827453500452&river=0&coast=0&farms=1&citadel=0&urban_castle=0&hub=1&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
burgName: Whiteston
burgNameID: Whiteston-452
...
culture: Skiple
elevation: 5788 ft
emblem: Hitchton Emblem Whiteston.png
group: town
feature: 2
id: 452
mapName: Hitchton
...
pronounced: ""
provinceId: 140
provinceName: Whiteston Captaincy
...
marker: burg,458.020,842.560,[[Whiteston]]
%%
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/city-generator/?name=Whiteston&population=8450&size=29&seed=5827453500452&river=0&coast=0&farms=1&citadel=0&urban_castle=0&hub=1&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Whiteston on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=842.56&y=859.98) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]+ Whiteston Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Whiteston-452.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
> render: dom
> align: center
> id: map-Whiteston-452
> view:
>   zoom: .5
>   centerX: .5
>   centerY: .5
> ```
> [Link to Whiteston on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Whiteston-452
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Whiteston-452.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
