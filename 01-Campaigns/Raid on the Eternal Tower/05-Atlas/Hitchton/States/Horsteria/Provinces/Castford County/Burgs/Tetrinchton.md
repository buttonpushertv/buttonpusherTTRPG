...
- Tetrinchton
- Tetrinchton-393
burgMapLink: https://watabou.github.io/city-generator/?name=Tetrinchton&population=2475&size=18&seed=5827453500393&river=0&coast=0&farms=1&citadel=0&urban_castle=0&hub=1&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
burgName: Tetrinchton
burgNameID: Tetrinchton-393
...
culture: Osbuton
elevation: 1312 ft
emblem: Hitchton Emblem Tetrinchton.png
group: town
feature: 2
id: 393
mapName: Hitchton
marketId: 6
marketName: Horston-market
plaza: 0
population: 2,475
port: 
product: 11.68
...
stateId: 13
stateName: Horsteria
stateNotePath: "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Horsteria/Horsteria"
tags:
- Burg
- Hitchton
- roet
...
marker: burg,789.540,877.340,[[Tetrinchton]]
%%
...
>> ![[Hitchton Emblem Tetrinchton.png]]
>
>> ### Information
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/city-generator/?name=Tetrinchton&population=2475&size=18&seed=5827453500393&river=0&coast=0&farms=1&citadel=0&urban_castle=0&hub=1&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Tetrinchton on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=877.34&y=528.46) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]+ Tetrinchton Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Tetrinchton-393.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
> render: dom
> align: center
> id: map-Tetrinchton-393
> view:
>   zoom: .5
>   centerX: .5
>   centerY: .5
> ```
> [Link to Tetrinchton on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Tetrinchton-393
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Tetrinchton-393.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
