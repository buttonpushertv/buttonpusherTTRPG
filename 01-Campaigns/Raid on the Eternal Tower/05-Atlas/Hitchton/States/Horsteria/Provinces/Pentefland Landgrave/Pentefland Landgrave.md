...
pulledName: Pentefland Landgrave
id: 133
name: Pentefland
...
>> ![[Hitchton Emblem Pentefland Landgrave.png]]
>
>> ### Information
...
> [!metadata|map]+ Pentefland Landgrave - Province World Map
> ```leaflet
> id: Province-Pentefland-133
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [535.690,818.110]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,535.690,818.110,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Horsteria/Provinces/Pentefland Landgrave/Burgs/Draxning|Draxning]],Pentefland Provincial Capital
> ```
>  [Link to Pentefland Landgrave on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=818.11&y=782.31)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Pentefland Landgrave Province Map
> ```zoommap
> imageBases:
...
> render: dom
> align: center
> id: map-Pentefland-133
> view:
>   zoom: 1.5
>   centerX: 0.3066615620214395
>   centerY: 0.5333839150227617
> ```
> [Link to Pentefland on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=818.11&y=782.31)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Pentefland-133
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Draxning_384",
      "x": 0.31321209800918837,
      "y": 0.5935584218512898,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Horsteria/Provinces/Pentefland Landgrave/Burgs/Draxning",
      "iconKey": "pinRed",
      "tooltip": "Pentefland Landgrave Capital - Draxning"
    }
  ],
  "bases": [
    {
