...
formName: County
fullName: Mering County
pulledName: Mering County
id: 109
name: Mering
nameID: Mering-109
mapName: Hitchton
...
>> ![[Hitchton Emblem Mering County.png]]
>
>> ### Information
...
> [!metadata|map]+ Mering County - Province World Map
> ```leaflet
> id: Province-Mering-109
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [904.200,1127.670]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,904.390,1127.650,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Padstedgia/Provinces/Mering County/Burgs/Mering|Mering]],Mering Provincial Capital
> ```
>  [Link to Mering County on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1127.67&y=413.8)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Mering County Province Map
> ```zoommap
> imageBases:
...
> view:
>   zoom: 1.5
>   centerX: 0.4261102603369066
>   centerY: 0.30273141122913505
> ```
> [Link to Mering on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1127.67&y=413.8)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Mering-109
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Mering_62",
      "x": 0.43171898928024505,
      "y": 0.3138163884673748,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Padstedgia/Provinces/Mering County/Burgs/Mering",
      "iconKey": "pinRed",
      "tooltip": "Mering County Capital - Mering"
    }
  ],
  "bases": [
    {
