...
- Tetforden
- Tetforden-170
burgMapLink: https://watabou.github.io/city-generator/?name=Tetforden&population=2495&size=18&seed=5827453500170&river=0&coast=0&farms=1&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
burgName: Tetforden
burgNameID: Tetforden-170
...
culture: Moury
elevation: 82 ft
emblem: Hitchton Emblem Tetforden.png
group: town
feature: 2
id: 170
mapName: Hitchton
...
marker: burg,997.700,1024.700,[[Tetforden]]
%%
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/city-generator/?name=Tetforden&population=2495&size=18&seed=5827453500170&river=0&coast=0&farms=1&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Tetforden on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=1024.7&y=320.3) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]+ Tetforden Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Tetforden-170.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
> render: dom
> align: center
> id: map-Tetforden-170
> view:
>   zoom: .5
>   centerX: .5
>   centerY: .5
> ```
> [Link to Tetforden on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Tetforden-170
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Tetforden-170.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
