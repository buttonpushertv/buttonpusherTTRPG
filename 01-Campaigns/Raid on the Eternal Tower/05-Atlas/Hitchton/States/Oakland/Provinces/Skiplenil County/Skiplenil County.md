...
formName: County
fullName: Skiplenil County
pulledName: Skiplenil County
id: 67
name: Skiplenil
nameID: Skiplenil-67
mapName: Hitchton
...
>> ![[Hitchton Emblem Skiplenil County.png]]
>
>> ### Information
...
> [!metadata|map]+ Skiplenil County - Province World Map
> ```leaflet
> id: Province-Skiplenil-67
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [626.660,2023.110]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,627.150,2023.460,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Oakland/Provinces/Skiplenil County/Burgs/Leridgewich|Leridgewich]],Skiplenil Provincial Capital
> ```
>  [Link to Skiplenil County on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=2023.11&y=691.34)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Skiplenil County Province Map
> ```zoommap
> imageBases:
...
> view:
>   zoom: 1.5
>   centerX: 0.7905819295558959
>   centerY: 0.5151745068285281
> ```
> [Link to Skiplenil on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=2023.11&y=691.34)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Skiplenil-67
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Leridgewich_643",
      "x": 0.7746784073506892,
      "y": 0.524165402124431,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Oakland/Provinces/Skiplenil County/Burgs/Leridgewich",
      "iconKey": "pinRed",
      "tooltip": "Skiplenil County Capital - Leridgewich"
    }
  ],
  "bases": [
    {
