...
formName: County
fullName: Albrid County
pulledName: Albrid County
id: 63
name: Albrid
nameID: Albrid-63
mapName: Hitchton
...
>> ![[Hitchton Emblem Albrid County.png]]
>
>> ### Information
...
> [!metadata|map]+ Albrid County - Province World Map
> ```leaflet
> id: Province-Albrid-63
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [655.990,1994.000]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,656.480,1994.340,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Oakland/Provinces/Albrid County/Burgs/Oakley|Oakley]],Albrid Provincial Capital
> ```
>  [Link to Albrid County on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1994&y=662.01)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Albrid County Province Map
> ```zoommap
> imageBases:
...
> view:
>   zoom: 1.5
>   centerX: 0.7599540581929556
>   centerY: 0.4992412746585736
> ```
> [Link to Albrid on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1994&y=662.01)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Albrid-63
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      ...
      "iconKey": "pinRed",
      "tooltip": "Albrid County Capital - Oakley"
    }
  ],
  "bases": [
    {
