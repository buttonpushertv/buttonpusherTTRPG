...
formName: County
fullName: Carpor County
pulledName: Carpor County
id: 69
name: Carpor
nameID: Carpor-69
mapName: Hitchton
...
>> ![[Hitchton Emblem Carpor County.png]]
>
>> ### Information
...
> [!metadata|map]+ Carpor County - Province World Map
> ```leaflet
> id: Province-Carpor-69
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [691.370,1987.710]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,691.640,1987.780,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Oakland/Provinces/Carpor County/Burgs/Carpor|Carpor]],Carpor Provincial Capital
> ```
>  [Link to Carpor County on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1987.71&y=626.63)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Carpor County Province Map
> ```zoommap
> imageBases:
...
> view:
>   zoom: 1.5
>   centerX: 0.7607197549770292
>   centerY: 0.47496206373292865
> ```
> [Link to Carpor on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1987.71&y=626.63)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Carpor-69
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Carpor_389",
      "x": 0.7610183767228178,
      "y": 0.4752352048558422,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Oakland/Provinces/Carpor County/Burgs/Carpor",
      "iconKey": "pinRed",
      "tooltip": "Carpor County Capital - Carpor"
    }
  ],
  "bases": [
    {
