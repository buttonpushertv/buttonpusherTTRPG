...
formName: Barony
fullName: Ormster Barony
pulledName: Ormster Barony
id: 94
name: Ormster
nameID: Ormster-94
mapName: Hitchton
...
>> ![[Hitchton Emblem Ormster Barony.png]]
>
>> ### Information
...
> [!metadata|map]+ Ormster Barony - Province World Map
> ```leaflet
> id: Province-Ormster-94
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [967.190,502.040]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,966.760,502.460,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Wodminia/Provinces/Ormster Barony/Burgs/Ormster|Ormster]],Ormster Provincial Capital
> ```
>  [Link to Ormster Barony on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=502.04&y=350.81)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Ormster Barony Province Map
> ```zoommap
> imageBases:
...
> view:
>   zoom: 1.5
>   centerX: 0.18644716692189892
>   centerY: 0.26934749620637327
> ```
> [Link to Ormster on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=502.04&y=350.81)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Ormster-94
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      ...
      "iconKey": "pinRed",
      "tooltip": "Ormster Barony Capital - Ormster"
    }
  ],
  "bases": [
    {
