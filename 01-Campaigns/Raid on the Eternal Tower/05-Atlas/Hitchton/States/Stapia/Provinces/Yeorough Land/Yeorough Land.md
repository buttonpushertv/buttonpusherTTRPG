...
formName: Land
fullName: Yeorough Land
pulledName: Yeorough Land
id: 221
name: Yeorough
nameID: Yeorough-221
mapName: Hitchton
...
>> ![[Hitchton Emblem Yeorough Land.png]]
>
>> ### Information
...
> [!metadata|map]+ Yeorough Land - Province World Map
> ```leaflet
> id: Province-Yeorough-221
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [948.080,1693.240]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,,[[|Unspecified]],Yeorough Provincial Capital
> ```
>  [Link to Yeorough Land on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1693.24&y=369.92)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Yeorough Land Province Map
> ```zoommap
> imageBases:
...
>   centerY: 0.2867981790591806
> ```
> [Link to Yeorough on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1693.24&y=369.92)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Yeorough-221
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      ...
      "link": "",
      "iconKey": "pinRed",
      "tooltip": "Yeorough Land Capital - Unspecified"
    }
  ],
  "bases": [
    {
