...
- Paignbeck
- Paignbeck-617
burgMapLink: https://watabou.github.io/village-generator/?pop=1474&name=Paignbeck&seed=5827453500617&width=1400&height=636&tags=coast%2Cisolated%2Cno+square%2Cdense
burgName: Paignbeck
burgNameID: Paignbeck-617
...
culture: Cliford
elevation: 948 ft
emblem: Hitchton Emblem Paignbeck.png
group: village
feature: 2
id: 617
mapName: Hitchton
...
marker: burg,998.270,1328.270,[[Paignbeck]]
%%
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/village-generator/?pop=1474&name=Paignbeck&seed=5827453500617&width=1400&height=636&tags=coast%2Cisolated%2Cno+square%2Cdense
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Paignbeck on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=1327.79&y=319.57) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]- Paignbeck Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Paignbeck-617.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
> render: dom
> align: center
> id: map-Paignbeck-617
> view:
>   zoom: .5
>   centerX: .5
>   centerY: .5
> ```
> [Link to Paignbeck on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

-TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Paignbeck-617
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Paignbeck-617.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
