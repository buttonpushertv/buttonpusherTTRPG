...
- Persbury
- Persbury-274
burgMapLink: https://watabou.github.io/village-generator/?pop=1355&name=Persbury&seed=5827453500274&width=1400&height=636&tags=isolated%2Cno+square%2Cdense
burgName: Persbury
burgNameID: Persbury-274
...
culture: Moury
elevation: 13 ft
emblem: Hitchton Emblem Persbury.png
group: village
feature: 2
id: 274
mapName: Hitchton
...
marker: burg,1002.000,914.000,[[Persbury]]
%%
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/village-generator/?pop=1355&name=Persbury&seed=5827453500274&width=1400&height=636&tags=isolated%2Cno+square%2Cdense
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Persbury on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=914&y=316) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]- Persbury Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Persbury-274.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
>   centerY: .5
> ```
> [Link to Persbury on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

-TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Persbury-274
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Persbury-274.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
