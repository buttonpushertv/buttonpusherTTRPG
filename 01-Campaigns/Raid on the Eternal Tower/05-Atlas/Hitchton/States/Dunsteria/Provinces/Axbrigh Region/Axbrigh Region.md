...
formName: Region
fullName: Axbrigh Region
pulledName: Axbrigh Region
id: 219
name: Axbrigh
nameID: Axbrigh-219
mapName: Hitchton
...
>> ![[Hitchton Emblem Axbrigh Region.png]]
>
>> ### Information
...
> [!metadata|map]+ Axbrigh Region - Province World Map
> ```leaflet
> id: Province-Axbrigh-219
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [1156.600,1267.910]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,,[[|Unspecified]],Axbrigh Provincial Capital
> ```
>  [Link to Axbrigh Region on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1267.91&y=161.4)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Axbrigh Region Province Map
> ```zoommap
> imageBases:
...
> view:
>   zoom: 1.5
>   centerX: 0.48392036753445633
>   centerY: 0.13125948406676782
> ```
> [Link to Axbrigh on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1267.91&y=161.4)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Axbrigh-219
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      ...
      "link": "",
      "iconKey": "pinRed",
      "tooltip": "Axbrigh Region Capital - Unspecified"
    }
  ],
  "bases": [
    {
