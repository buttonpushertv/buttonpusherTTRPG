...
formName: County
fullName: Loutland County
pulledName: Loutland County
id: 27
name: Loutland
nameID: Loutland-27
mapName: Hitchton
...
>> ![[Hitchton Emblem Loutland County.png]]
>
>> ### Information
...
> [!metadata|map]+ Loutland County - Province World Map
> ```leaflet
> id: Province-Loutland-27
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [431.780,1697.590]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,431.780,1697.590,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Casthamia/Provinces/Loutland County/Burgs/Thetle|Thetle]],Loutland Provincial Capital
> ```
>  [Link to Loutland County on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1697.59&y=886.22)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Loutland County Province Map
> ```zoommap
> imageBases:
...
> view:
>   zoom: 1.5
>   centerX: 0.6370597243491577
>   centerY: 0.6555386949924128
> ```
> [Link to Loutland on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1697.59&y=886.22)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Loutland-27
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Thetle_502",
      "x": 0.6499196018376723,
      "y": 0.6723975720789075,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Casthamia/Provinces/Loutland County/Burgs/Thetle",
      "iconKey": "pinRed",
      "tooltip": "Loutland County Capital - Thetle"
    }
  ],
  "bases": [
    {
