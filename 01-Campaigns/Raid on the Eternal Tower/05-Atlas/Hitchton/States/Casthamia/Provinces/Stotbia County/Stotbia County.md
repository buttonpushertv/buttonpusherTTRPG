...
>> ![[Hitchton Emblem Stotbia County.png]]
>
>> ### Information
...
> [!metadata|map]+ Stotbia County - Province World Map
> ```leaflet
> id: Province-Stotbia-35
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [491.550,1475.710]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,491.550,1475.710,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Casthamia/Provinces/Stotbia County/Burgs/Congton|Congton]],Stotbia Provincial Capital
> ```
>  [Link to Stotbia County on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1475.71&y=826.45)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Stotbia County Province Map
> ```zoommap
> imageBases:
...
> view:
>   zoom: 1.5
>   centerX: 0.5509188361408882
>   centerY: 0.6350531107738998
> ```
> [Link to Stotbia on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1475.71&y=826.45)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Stotbia-35
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Congton_291",
      "x": 0.5649732006125574,
      "y": 0.6270485584218514,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Casthamia/Provinces/Stotbia County/Burgs/Congton",
      "iconKey": "pinRed",
      "tooltip": "Stotbia County Capital - Congton"
    }
  ],
  "bases": [
    {
