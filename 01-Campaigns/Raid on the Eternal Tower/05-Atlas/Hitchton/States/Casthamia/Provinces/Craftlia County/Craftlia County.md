...
formName: County
fullName: Craftlia County
pulledName: Craftlia County
id: 40
name: Craftlia
nameID: Craftlia-40
mapName: Hitchton
...
>> ![[Hitchton Emblem Craftlia County.png]]
>
>> ### Information
...
> [!metadata|map]+ Craftlia County - Province World Map
> ```leaflet
> id: Province-Craftlia-40
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [375.860,1666.840]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,375.580,1666.720,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Casthamia/Provinces/Craftlia County/Burgs/Gatham|Gatham]],Craftlia Provincial Capital
> ```
>  [Link to Craftlia County on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1666.84&y=942.14)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Craftlia County Province Map
> ```zoommap
> imageBases:
...
> view:
>   zoom: 1.5
>   centerX: 0.6378254211332313
>   centerY: 0.7033383915022762
> ```
> [Link to Craftlia on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1666.84&y=942.14)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Craftlia-40
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Gatham_59",
      "x": 0.6381010719754977,
      "y": 0.7150379362670712,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Casthamia/Provinces/Craftlia County/Burgs/Gatham",
      "iconKey": "pinRed",
      "tooltip": "Craftlia County Capital - Gatham"
    }
  ],
  "bases": [
    {
