...
formName: Landgrave
fullName: Chilworthia Landgrave
pulledName: Chilworthia Landgrave
id: 23
name: Chilworthia
...
>> ![[Hitchton Emblem Chilworthia Landgrave.png]]
>
>> ### Information
...
> [!metadata|map]+ Chilworthia Landgrave - Province World Map
> ```leaflet
> id: Province-Chilworthia-23
> image: [[Hitchton Provinces World Map.svg]]
> bounds:
> - [0,0]
> - [1318,2612]
> coordinates: [684.500,1405.200]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 5
> darkMode: false
> marker: prov_capital,691.620,1400.260,[[01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Casthamia/Provinces/Chilworthia Landgrave/Burgs/Knutsin|Knutsin]],Chilworthia Provincial Capital
> ```
>  [Link to Chilworthia Landgrave on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1405.2&y=633.5)

-LeafletMapTAIL%%

%%TTRPGMapTOP%%

> [!metadata|map]+ Chilworthia Landgrave Province Map
> ```zoommap
> imageBases:
...
> render: dom
> align: center
> id: map-Chilworthia-23
> view:
>   zoom: 1.5
>   centerX: 0.5363705972434916
>   centerY: 0.47192716236722304
> ```
> [Link to Chilworthia on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3&x=1405.2&y=633.5)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Chilworthia-23
{
  "size": {
    "w": 2612,
    "h": 1318
  ...
  "markers": [
    {
      "type": "pin",
      "id": "marker_Knutsin_569",
      "x": 0.5360872894333844,
      "y": 0.4752503793626707,
      "layer": "default",
      "link": "01-Campaigns/Raid on the Eternal Tower/05-Atlas/Hitchton/States/Casthamia/Provinces/Chilworthia Landgrave/Burgs/Knutsin",
      "iconKey": "pinRed",
      "tooltip": "Chilworthia Landgrave Capital - Knutsin"
    }
  ],
  "bases": [
    {
