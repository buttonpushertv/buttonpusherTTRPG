...
- Holceston
- Holceston-227
burgMapLink: https://watabou.github.io/city-generator/?name=Holceston&population=5043&size=24&seed=5827453500227&river=0&coast=0&farms=0&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
burgName: Holceston
burgNameID: Holceston-227
...
culture: Skiple
elevation: 1063 ft
emblem: Hitchton Emblem Holceston.png
group: town
feature: 2
id: 227
mapName: Hitchton
...
pronounced: ""
provinceId: 37
provinceName: Thetfordia County
...
marker: burg,357.660,1463.050,[[Holceston]]
%%
...
> style: height: 1000px;
> urlSuffix: https://watabou.github.io/city-generator/?name=Holceston&population=5043&size=24&seed=5827453500227&river=0&coast=0&farms=0&citadel=0&urban_castle=0&hub=0&plaza=0&temple=0&walls=0&shantytown=0&greens=0&style=natural
> ```
>
>  `=elink(this.burgMapLink,"Visit Burg Map on MCFG")` | [Link to Holceston on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=6&x=1463.05&y=960.34) | Download Helper Link: `BUTTON[mapLink-to-download]`
...
> [!metadata|map]+ Holceston Burg Map
> ```zoommap
> imageBases:
>   - path: 01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Holceston-227.png
> markerLayers:
>   - Default
> minZoom: 0.50
> maxZoom: 8
...
> render: dom
> align: center
> id: map-Holceston-227
> view:
>   zoom: .5
>   centerX: .5
>   centerY: .5
> ```
> [Link to Holceston on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/l7dpjh1fb1v053mc7izmw/Hitchton-2026-06-21-15-36.map?rlkey=zrhhfmejskvk1cpgiizmjbrfl&dl=0&scale=3)

%%TTRPGMapTAIL%%

%%
ZOOMMAP-DATA id=map-Holceston-227
{
  "layers": [
    {
      "id": "default",
  ...
  "overlays": [],
  "activeBase": "01-Campaigns/Raid on the Eternal Tower/98-Raid on the Eternal Tower Assets/burg-maps/Holceston-227.png",
  "measurement": {
    "displayUnit": "m",
    "scales": {},
    "customUnitPxPerUnit": {},
