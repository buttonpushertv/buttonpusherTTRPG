---
aliases: Bjorvimaaja
burgMapLink: https://watabou.github.io/village-generator/?pop=1476&name=Bjorvimaaja&seed=9151100960521&width=1400&height=636&tags=coast%2Chighway%2Cuncultivated%2Cno+square%2Cdense
burgName: Bjorvimaaja
...
culture: Soumi
elevation: 82 ft
emblem: TCL-Ladonia Emblem Bjorvimaaja.png
feature: 5
id: 521
plaza: 0
population: 1,476
...
marker: burg,622.500,1912.500,[[Bjorvimaaja]]
%%
...
> actions:
>   - type: open
>     link: "obsidian://opengate?title=${context.bound.name}&url=${url}"
> ~~~
> `)
> ```
>
...
> 
> [Link to Bjorvimaaja on FMG Map](https://azgaar.github.io/Fantasy-Map-Generator/?maplink=https://dl.dropboxusercontent.com/scl/fi/s1ildj50q943p20hgqsvz/Ladonia-2024-04-13-18-07.map?rlkey=tt7j7x4gqbhxu043p5q2f2ucx&dl=0&scale=3&x=1913.98&y=703.3)

> [!metadata]+ Burg Map (Live from Web)
> ```custom-frames
> frame: Watabou-Procgen Arcana
> style: height: 1000px;
> urlSuffix: /village-generator/?pop=1476&name=Bjorvimaaja&seed=9151100960521&width=1400&height=636&tags=coast%2Chighway%2Cuncultivated%2Cno+square%2Cdense
> ```
>  `=elink(this.burgMapLink,"Visit Burg Map")`
>
...
> [!infobox]
> ![[TCL-Ladonia Emblem Bjorvimaaja.png]]
>
>  |
>  --- |
> 
