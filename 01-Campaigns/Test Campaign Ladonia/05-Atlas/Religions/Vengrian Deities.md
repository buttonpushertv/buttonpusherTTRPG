...
deity: Pederegyesza, The Pregnant Bear
expansion: culture
expansionism: 0
followers: 3347618
form: Polytheism
...
> [!metadata|map]- Vengrian Deities Religions Map
> ```leaflet
> id: Religion-Vengrian Deities
> image: [[Ladonia Religions World Map.svg]]
> bounds: 
> - [0,0]
> - [1317,2291]
> coordinates: [209.560,2198.600]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 2
> darkMode: false
> marker: religion,209.560,2198.600,,Religion's Center
> ```
> <div style="width: 250px; height: 50px; background-color: #bc80bd; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #bc80bd;">▮</div>
