...
deity: Poporysos, The Golden Home
expansion: culture
expansionism: 0
followers: 55436
form: Shamanism
...
> [!metadata|map]- Elladan Beliefs Religions Map
> ```leaflet
> id: Religion-Elladan Beliefs
> image: [[Ladonia Religions World Map.svg]]
> bounds: 
> - [0,0]
> - [1317,2291]
> coordinates: [191.420,12.140]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 2
> darkMode: false
> marker: religion,191.420,12.140,,Religion's Center
> ```
> <div style="width: 250px; height: 50px; background-color: #ccebc5; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #ccebc5;">▮</div>
