...
deity: Aflaso, The Cat of Springs
expansion: culture
expansionism: 0
followers: 244862
form: Nature Worship
...
> [!metadata|map]- Tallian Beliefs Religions Map
> ```leaflet
> id: Religion-Tallian Beliefs
> image: [[Ladonia Religions World Map.svg]]
> bounds: 
> - [0,0]
> - [1317,2291]
> coordinates: [1309.530,1036.100]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 2
> darkMode: false
> marker: religion,1309.530,1036.100,,Religion's Center
> ```
> <div style="width: 250px; height: 50px; background-color: #b3de69; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #b3de69;">▮</div>
