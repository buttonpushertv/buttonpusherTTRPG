...
origins: 0
pronounced:
religionName: "Astellian Beliefs"
shortDescription:
tags:
- Religion
- Ladonia
...
> [!metadata|map]- Astellian Beliefs Religions Map
> ```leaflet
> id: Religion-Astellian Beliefs
> image: [[Ladonia Religions World Map.svg]]
> bounds: 
> - [0,0]
> - [1317,2291]
> coordinates: [925.150,2046.210]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 2
> darkMode: false
> marker: religion,925.150,2046.210,,Religion's Center
> ```
> <div style="width: 250px; height: 50px; background-color: #c6b9c1; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #c6b9c1;">▮</div>
