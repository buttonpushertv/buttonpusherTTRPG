...
deity: Cythoporyst, The Cobra of Thunder
expansion: global
expansionism: 10
followers: 16196786
form: Monotheism
...
> [!metadata|map]- Cythoporystism Religions Map
> ```leaflet
> id: Religion-Cythoporystism
...
> scale: 2
> darkMode: false
> marker: religion,688.620,50.760,,Religion's Center
> ```
> <div style="width: 250px; height: 50px; background-color: #bdf8eb; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #bdf8eb;">▮</div>
