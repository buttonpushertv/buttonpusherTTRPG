...
campaignHomeNote: Escape from the Eternal Throne Home
campaignSimpleAtlas: Escape from the Eternal Throne-Simple Atlas
campaignCalendar: Escape from the Eternal Throne-Calendar
campaignStatus: 
campaignSystem:
...
# The World of Escape from the Eternal Throne

[[Escape from the Eternal Throne-Simple Atlas]]

```dataview
TABLE WITHOUT ID file.link as "Linked Atlases"
FROM #linked-atlas and "01-Campaigns/Escape from the Eternal Throne/05-Atlas"
SORT file.name ASC
```
...
![[Escape from the Eternal Throne Session Hub]]
...
> new_data = {
>     "importInfo":{
>     "thisCampaign": "Escape from the Eternal Throne",
>     "thisCampaignPath": "01-Campaigns/Escape from the Eternal Throne",
>     "thisCampaignShortCode": "efet",
>     "mapDropboxFMGLink": "{FMGDropboxLink}"
>     }
> }
> # Some of the values above may already have the correct info for this campaign: Escape from the Eternal Throne
