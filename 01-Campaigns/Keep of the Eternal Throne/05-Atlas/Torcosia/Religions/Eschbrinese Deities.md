...
origins: 9
pronounced:
religionName: "Eschbrinese Deities"
shortDescription:
tags:
- Religion
- Torcosia
...
> [!metadata|map]- Eschbrinese Deities Religions Map
> ```leaflet
> id: Religion-Eschbrinese Deities
...
> scale: 3
> darkMode: false
> marker: religion,511.600,1592.300,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #e4e171; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #e4e171;">▮</div>
> The area shown in the color above is the reach of Eschbrinese Deities
