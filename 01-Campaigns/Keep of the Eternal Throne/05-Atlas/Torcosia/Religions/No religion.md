...
> [!metadata|map]- No religion Religions Map
> ```leaflet
> id: Religion-No religion
...
> scale: 3
> darkMode: false
> marker: religion,,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: ; display: flex; justify-content: center; align-items: center; font-size: 24px; color: ;">▮</div>
