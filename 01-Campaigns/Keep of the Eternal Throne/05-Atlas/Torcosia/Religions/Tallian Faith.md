...
> [!metadata|map]- Tallian Faith Religions Map
> ```leaflet
> id: Religion-Tallian Faith
> image: [[Torcosia Religions World Map.svg]]
> bounds:
> - [0,0]
> - [1294,2560]
> coordinates: [843.710,1088.850]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 3
> darkMode: false
> marker: religion,843.710,1088.850,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #8dd3c7; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #8dd3c7;">▮</div>
> The area shown in the color above is the reach of Tallian Faith
