...
> [!metadata|map]- Angshire Spirits Religions Map
> ```leaflet
> id: Religion-Angshire Spirits
> image: [[Torcosia Religions World Map.svg]]
> bounds:
> - [0,0]
> - [1294,2560]
> coordinates: [928.510,2180.860]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 3
> darkMode: false
> marker: religion,928.510,2180.860,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #ffed6f; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #ffed6f;">▮</div>
> The area shown in the color above is the reach of Angshire Spirits
