...
> [!metadata|map]- Vengrian Spirits Religions Map
> ```leaflet
> id: Religion-Vengrian Spirits
> image: [[Torcosia Religions World Map.svg]]
> bounds:
> - [0,0]
> - [1294,2560]
> coordinates: [619.140,408.940]
> height: 600px
> width: 100%
> minZoom: -3
> maxZoom: 5
...
> scale: 3
> darkMode: false
> marker: religion,619.140,408.940,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #c6b9c1; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #c6b9c1;">▮</div>
> The area shown in the color above is the reach of Vengrian Spirits
