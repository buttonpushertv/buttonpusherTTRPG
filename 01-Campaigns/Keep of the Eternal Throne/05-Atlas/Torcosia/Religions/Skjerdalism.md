...
> [!metadata|map]- Skjerdalism Religions Map
> ```leaflet
> id: Religion-Skjerdalism
...
> scale: 3
> darkMode: false
> marker: religion,310.700,957.100,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #f78398; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #f78398;">▮</div>
> The area shown in the color above is the reach of Skjerdalism
