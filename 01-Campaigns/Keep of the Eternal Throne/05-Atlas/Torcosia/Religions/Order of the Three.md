...
origins: 2
pronounced:
religionName: "Order of the Three"
shortDescription:
tags:
- Religion
- Torcosia
...
> [!metadata|map]- Order of the Three Religions Map
> ```leaflet
> id: Religion-Order of the Three
...
> scale: 3
> darkMode: false
> marker: religion,958.500,509.500,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #af66ca; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #af66ca;">▮</div>
> The area shown in the color above is the reach of Order of the Three
