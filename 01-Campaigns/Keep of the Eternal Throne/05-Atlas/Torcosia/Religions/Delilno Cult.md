...
culture: Slovan
deity: Nicha, The Supreme Being
expansion: global
expansionism: 8.3
followers: 11,676,662
form: Dualism
id: 16
leaders:
mapName: Torcosia
...
> [!metadata|map]- Delilno Cult Religions Map
> ```leaflet
> id: Religion-Delilno Cult
...
> scale: 3
> darkMode: false
> marker: religion,360.720,2061.000,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #ae9de3; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #ae9de3;">▮</div>
> The area shown in the color above is the reach of Delilno Cult
