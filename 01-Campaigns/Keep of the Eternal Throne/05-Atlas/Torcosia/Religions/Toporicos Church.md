...
> [!metadata|map]- Toporicos Church Religions Map
> ```leaflet
> id: Religion-Toporicos Church
...
> scale: 3
> darkMode: false
> marker: religion,806.400,911.000,,Religion's Center
> ```
> <div style="width: 500px; height: 20px; background-color: #beffd0; display: flex; justify-content: center; align-items: center; font-size: 24px; color: #beffd0;">▮</div>
> The area shown in the color above is the reach of Toporicos Church
